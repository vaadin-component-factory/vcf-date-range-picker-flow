...
/**
 * View for testing validation with {@link EnhancedDatePicker}.
 */
@Route("date-picker-validation")
public class DatePickerValidationPage extends Div {

    final String STATUS = "The Invalid state of the EnhancedDatePicker is ";
    ...
    private void initView() {
        ...
        button = new NativeButton("Open EnhancedDatePicker");
        button.setId("open");
    ...
    private void createPickerWithValueAndLocaleFromServerSide() {
        EnhancedDatePicker datePicker = new EnhancedDatePicker(LocalDate.of(2018, 5, 23));
