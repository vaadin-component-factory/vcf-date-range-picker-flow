...
/**
 * Integration tests for {@link EnhancedDatePicker} validation.
 */
@TestPath("date-picker-validation")
public class EnhancedDatePickerValidationPageIT extends AbstractComponentIT {
    ...
    public void invalidLocale() {
        ...
        Assert.assertEquals("EnhancedDatePicker should use default locale(en-US) setPattern, MM/DD/YYYY", true,
    ...
    public void testDifferentLocales() {
        ...
        Assert.assertEquals("Polish Locale is using DD.MM.YYYY setPattern ", true,
        ...
        Assert.assertEquals("Swedish Locale is using YYYY-MM-DD setPattern ", true,
