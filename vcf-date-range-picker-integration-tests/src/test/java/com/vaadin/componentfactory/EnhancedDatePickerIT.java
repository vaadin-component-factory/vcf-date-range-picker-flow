...
import com.vaadin.componentfactory.demo.EnhancedDatePickerView;
...
/**
 * Integration tests for the {@link EnhancedDatePickerView}.
 */
public class EnhancedDatePickerIT extends ComponentDemoTest {
    ...
    public void selectDatesOnCustomLocaleDatePickers() {
        ...
        Assert.assertEquals(
                "The setPattern of the displayed date should be MM/DD/YYYY.", true,
        ...
        Assert.assertEquals(
                "The setPattern of the displayed date should be DD/MM/YYYY.", true,
