...
final class EnhancedDateRangePickerValidationUtil {
    ...
    static void disableClientValidation(EnhancedDateTimeRangePicker component) {
    ...
    private static void overrideClientValidation(EnhancedDateTimeRangePicker component) {
